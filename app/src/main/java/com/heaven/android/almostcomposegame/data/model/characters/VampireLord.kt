...
class VampireLord(
    ...
    // Ability:
    // Passive: Vampire basic attacks restore 75% of dealt damage as health.
    // Active: Vampire casts a powerful spell, dealing 20 damage to all enemies and restoring 50% of dealt damage as health.
    constructor() : this(
        "Vampire Lord",
        R.drawable.vampire_lord,
        200,
        24,
        Range.MELEE,
        Ability(
            name = "Lifesteal",
            description = "Passive: Vampire basic attacks restore 75% of dealt damage as health.",
            cooldown = 0,
    ...
    override fun getCopy() : VampireLord {
        return VampireLord(
                name,
                imageId,
                totalHealth,
            ...
            this.currentHealth = this@VampireLord.currentHealth
        }
    }
}
